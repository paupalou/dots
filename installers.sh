...
source "${__dots_folder}/script/system_utils.sh"
source "${__dots_folder}/script/yaml_parser.sh"
source "${__dots_folder}/script/print_utils.sh"
...
function _install_item {
    ...
    _print_colored "└" "$blue"
    _space
    _print_colored installing
    _space
    _print_colored "$name" "$cyan$uline"
    _space
    _print_colored from
    _space
    _print_colored "$from" "$cyan"
